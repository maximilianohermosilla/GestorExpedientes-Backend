...
namespace GestorExpediente.Controllers
{
    ...
    public class SituacionRevistaController : ControllerBase
    {
        ...
        public SituacionRevistaController(GestorExpedienteContext context, IConfiguration configuration, IMapper mapper, ILogger<SituacionRevistaController> logger)
        {
            _contexto = context;

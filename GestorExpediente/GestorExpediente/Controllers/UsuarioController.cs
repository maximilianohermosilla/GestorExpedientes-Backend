...
using GestorExpediente.Helpers;
...
namespace GestorExpediente.Controllers
{
    ...
    public class UsuarioController : ControllerBase
    {
        ...
        public UsuarioController(IConfiguration config, GestorExpedienteContext context, IConfiguration configuration, IMapper mapper)
        {
        ...
        private UsuarioDTO Authenticate(UsuarioLoginDTO userLogin)
        {
            ...
            if (_user != null)
            {
                ...
                if (_perfil != null)
                {
                    _userDTO.Perfil = _perfil.Nombre;
                }
            }
